...
Javaで作成した社内向け問い合わせ管理システムです。問い合わせの登録・一覧表示・検索・ステータス更新に対応しており、CSVエクスポート機能も実装しています。業務システムで一般的なCRUD処理と状態管理を再現した、北都システム向けのポートフォリオ用アプリケーションです。
---
